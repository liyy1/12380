...
import com.domor.service.MenuService;
...
public class MenuController {
    ...
    public ModelAndView insertGet(HttpServletRequest request) {
        ...
        return new ModelAndView("/admin/menu/menu_add", "parent", parent);
    }
    ...
    public Object updateGet(HttpServletRequest request) {
        ...
        ModelAndView mv = new ModelAndView("/admin/menu/menu_edit");
    ...
    public ModelAndView list(HttpServletRequest request) {
        return new ModelAndView("/admin/menu/menu");
    }
